...
module.exports = withPlausibleProxy({
  ...
  // Self-host on Railway: build a standalone Node server (no Vercel).
  output: "standalone",
  outputFileTracingRoot: require("path").join(__dirname, "../../"),
  // The upstream monorepo is large; don't let stray type/lint issues from our
  // fork block the container build.
